...
// Import r-series photos for traditional display
...
const TraditionalDisplay = () => {
  ...
  const images = [r1, r2, r3, r4, r5, r6, r7, r8, r9];
  ...
  return (
    <div className="screen" style={{ 
      minHeight: '100vh',
      background: 'linear-gradient(135deg, #fff8dc 0%, #ffefd5 50%, #fff8dc 100%)'
    }}>
        ...
        <div className="desktop-image-grid fade-in-up" style={{ position: 'relative' }}>
          {getCurrentSetImages().map((img, index) => (
            <img
              ...
              src={img}
              alt={`Traditional Memory ${currentSetIndex * 3 + index + 1}`}
          ...
          <div className="slide-container">
            {images.map((img, index) => (
              ...
              >
                <img
                  src={img}
                  alt={`Traditional Memory ${index + 1}`}
                  className="img-fluid"
                />
              </div>
            ))}
...
export default TraditionalDisplay;
